...
create table tests(test_id SERIAL PRIMARY key, test_name VARCHAR(255));

create table options(option_id SERIAL PRIMARY key, question_id INT, answer_id INT, test_id INT);
